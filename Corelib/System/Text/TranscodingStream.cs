...
namespace System.Text
{
    internal sealed class TranscodingStream : Stream
    {
        ...
        public override long Length => throw new NotSupportedException(NotSupportedException.UnseekableStream);

        public override long Position
        {
            get => throw new NotSupportedException(NotSupportedException.UnseekableStream);
...
#pragma warning restore CS3016 // Arrays as attribute arguments is not CLS-compliant
        ...
        public override long Seek(long offset, SeekOrigin origin)
            => throw new NotSupportedException(NotSupportedException.UnseekableStream);
