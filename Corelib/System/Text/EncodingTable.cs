...
namespace System.Text
{
    ...
    {
        private static readonly Dictionary<string, int> s_nameToCodePage = new();
        ...
        **  internalGetCodePageFromName will throw ArgumentException if name is not a valid encoding name.
        ...
        internal static int GetCodePageFromName(string name)
        {
            ...
            {
                if (s_nameToCodePage.TryGetValue(name, out codePage)) 
                    return codePage;
        ...
        private static int InternalGetCodePageFromName(string name)
        {
            ...
            throw new ArgumentException(
                $"'{name}' is not a supported encoding name.",
                nameof(name));
        }
        ...
        internal static EncodingInfo[] GetEncodings()
        {
            ...
            EncodingInfo[] arrayEncodingInfo = new EncodingInfo[mappedCodePages.Length - 1];
            ...
            for (int i = 0; i < mappedCodePages.Length; i++)
            {
                ...
                if (codePage == Encoding.CodePageUTF7)
                {
        ...
        {
            return s_englishNames[s_englishNameIndices[englishNameIndex]..s_englishNameIndices[englishNameIndex + 1]];
        }
    }
}
