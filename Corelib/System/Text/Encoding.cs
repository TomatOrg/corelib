...
namespace System.Text
{
    ...
    public abstract partial class Encoding : ICloneable
    {
        ...
        // Special code pages
        // TODO: remove every reference to utf7
        ...
        public static Encoding GetEncoding(int codepage)
        {
            ...
            switch (codepage)
            {
                ...
                case CodePageNoSymbol:                           // 42 CP_SYMBOL
                    throw new ArgumentException($"{codepage} is not a supported code page.", nameof(codepage));
            }

            if (codepage < 0 || codepage > 65535)
            {
                throw new ArgumentOutOfRangeException(
                    nameof(codepage), "Valid values are between 0 and 65535, inclusive.");
            }
        ...
        private void GetDataItem()
        {
            if (_dataItem == null)
            {
                ...
                if (_dataItem == null)
                {
                    throw new NotSupportedException($"No data is available for encoding {_codePage}.");
                }
            }
        }
        ...
        public EncoderFallback EncoderFallback
        {
            ...
            {
                if (this.IsReadOnly)
                    throw new InvalidOperationException(InvalidOperationException.ReadOnly);
        ...
        public int GetByteCount(string s, int index, int count)
        {
            ...
            if (index > s.Length - count)
                throw new ArgumentOutOfRangeException(nameof(index),
                    ArgumentOutOfRangeException.IndexCount);
        ...
        internal unsafe string GetString(byte* bytes, int byteCount)
        {
            if (bytes == null)
                throw new ArgumentNullException(nameof(bytes), ArgumentNullException.Array);

            if (byteCount < 0)
                throw new ArgumentOutOfRangeException(nameof(byteCount), ArgumentOutOfRangeException.NeedNonNegNum);
        ...
        internal void ThrowBytesOverflow() =>
            ...
            throw new ArgumentException(
                $"The output byte buffer is too small to contain the encoded data, encoding '{EncodingName}' fallback '{EncoderFallback.GetType()}'.",
                "bytes");
        ...
        internal static void ThrowConversionOverflow() =>
            throw new ArgumentException(ArgumentException.ConversionOverflow);
        ...
        internal void ThrowCharsOverflow() =>
            ...
            throw new ArgumentException(
                $"The output char buffer is too small to contain the decoded characters, encoding '{EncodingName}' fallback '{DecoderFallback.GetType()}'.",
                "chars");
        ...
        internal sealed class DefaultEncoder : Encoder
        {
            ...
            internal override unsafe int GetByteCount(char* chars, int count, bool flush) =>
        ...
        internal sealed class DefaultDecoder : Decoder
        {
            ...
            internal override unsafe int GetCharCount(byte* bytes, int count, bool flush) =>
                        ...
                        byte* inByteStart, int inByteCount, char* inCharStart, int inCharCount)
            {
                ...
                else
                {
                    ...
                    if (_encoder._throwOnOverflow && _encoder.InternalHasFallbackBuffer &&
                        ...
                        throw new ArgumentException(
                            $"Must complete Convert() operation or call Encoder.Reset() before calling GetBytes() or GetByteCount(). Encoder '{_encoder.Encoding.EncodingName}' fallback '{_encoder.Fallback!.GetType()}'.");
                }
