    ...
    public sealed class UTF32Encoding : Encoding
    {
        ...
        */
        ...
        public override unsafe int GetByteCount(char[] chars, int index, int count)
        {
            ...
            if (chars == null)
                throw new ArgumentNullException(nameof(chars), ArgumentNullException.Array);

            if (index < 0 || count < 0)
                throw new ArgumentOutOfRangeException(index < 0 ? nameof(index) : nameof(count), ArgumentOutOfRangeException.NeedNonNegNum);

            if (chars.Length - index < count)
                throw new ArgumentOutOfRangeException(nameof(chars), ArgumentOutOfRangeException.IndexCountBuffer);
                                              ...
                                              byte[] bytes, int byteIndex)
        {
            if (s == null || bytes == null)
                throw new ArgumentNullException(s == null ? nameof(s) : nameof(bytes), ArgumentNullException.Array);

            if (charIndex < 0 || charCount < 0)
                throw new ArgumentOutOfRangeException(charIndex < 0 ? nameof(charIndex) : nameof(charCount), ArgumentOutOfRangeException.NeedNonNegNum);

            if (s.Length - charIndex < charCount)
                throw new ArgumentOutOfRangeException(nameof(s), ArgumentOutOfRangeException.IndexCount);

            if (byteIndex < 0 || byteIndex > bytes.Length)
                throw new ArgumentOutOfRangeException(nameof(byteIndex), ArgumentOutOfRangeException.Index);
                                               ...
                                               byte[] bytes, int byteIndex)
        {
            ...
            if (chars == null || bytes == null)
                throw new ArgumentNullException(chars == null ? nameof(chars) : nameof(bytes), ArgumentNullException.Array);
        ...
        internal override unsafe int GetBytes(char* chars, int charCount, byte* bytes, int byteCount)
        {
            ...
            if (bytes == null || chars == null)
                throw new ArgumentNullException(bytes == null ? nameof(bytes) : nameof(chars), ArgumentNullException.Array);

            if (charCount < 0 || byteCount < 0)
                throw new ArgumentOutOfRangeException(charCount < 0 ? nameof(charCount) : nameof(byteCount), ArgumentOutOfRangeException.NeedNonNegNum);
        ...
        public override unsafe int GetCharCount(byte[] bytes, int index, int count)
        {
            // Validate Parameters
            if (bytes == null)
                throw new ArgumentNullException(nameof(bytes), ArgumentNullException.Array);

            if (index < 0 || count < 0)
                throw new ArgumentOutOfRangeException(index < 0 ? nameof(index) : nameof(count), ArgumentOutOfRangeException.NeedNonNegNum);

            if (bytes.Length - index < count)
                throw new ArgumentOutOfRangeException(nameof(bytes), ArgumentOutOfRangeException.IndexCountBuffer);
                                              ...
                                              char[] chars, int charIndex)
        {
            ...
            if (byteIndex < 0 || byteCount < 0)
                throw new ArgumentOutOfRangeException(byteIndex < 0 ? nameof(byteIndex) : nameof(byteCount), ArgumentOutOfRangeException.NeedNonNegNum);

            if (bytes.Length - byteIndex < byteCount)
                throw new ArgumentOutOfRangeException(nameof(bytes), ArgumentOutOfRangeException.IndexCountBuffer);

            if (charIndex < 0 || charIndex > chars.Length)
                throw new ArgumentOutOfRangeException(nameof(charIndex), ArgumentOutOfRangeException.Index);
        ...
        internal override unsafe int GetChars(byte* bytes, int byteCount, char* chars, int charCount)
        {
            // Validate Parameters
            if (bytes == null || chars == null)
                throw new ArgumentNullException(bytes == null ? nameof(bytes) : nameof(chars), ArgumentNullException.Array);
            ...
            if (encoder != null)
            {
                ...
                if (fallbackBuffer.Remaining > 0)
                    throw new ArgumentException(
                        $"Must complete Convert() operation or call Encoder.Reset() before calling GetBytes() or GetByteCount(). Encoder '{this.EncodingName}' fallback '{encoder.Fallback?.GetType().ToString() ?? string.Empty}'.");
            }
            else
            {
        ...
        TryAgain:
            ...
            // Check for overflows.
            if (byteCount < 0)
                throw new ArgumentOutOfRangeException(nameof(count), ArgumentOutOfRangeException.GetByteCountOverflow);
                                                 ...
                                                 byte* bytes, int byteCount, EncoderNLS? encoder)
        {
            ...
            if (encoder != null)
            {
                ...
                if (encoder._throwOnOverflow && fallbackBuffer.Remaining > 0)
                    throw new ArgumentException(
                        $"Must complete Convert() operation or call Encoder.Reset() before calling GetBytes() or GetByteCount(). Encoder '{this.EncodingName}' fallback '{encoder.Fallback?.GetType()}'.");
            }
            else
            {
                fallbackBuffer = this.encoderFallback.CreateFallbackBuffer();
        ...
        public override int GetMaxByteCount(int charCount)
        {
            if (charCount < 0)
                throw new ArgumentOutOfRangeException(nameof(charCount),
                     ArgumentOutOfRangeException.NeedNonNegNum);
            ...
            if (byteCount > 0x7fffffff)
                throw new ArgumentOutOfRangeException(nameof(charCount), ArgumentOutOfRangeException.GetByteCountOverflow);
        ...
        public override int GetMaxCharCount(int byteCount)
        {
            ...
            if (charCount > 0x7fffffff)
                throw new ArgumentOutOfRangeException(nameof(byteCount), ArgumentOutOfRangeException.GetCharCountOverflow);
