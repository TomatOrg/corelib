...
namespace System.Text
{
    ...
    public abstract class EncoderFallbackBuffer
    {
        ...
        private Rune GetNextRune()
        {
            ...
            throw new ArgumentException(ArgumentException.InvalidCharSequenceNoIndex);
        }
        ...
        internal static void ThrowLastCharRecursive(int charRecursive) =>
            ...
            throw new ArgumentException($"Recursive fallback not allowed for character \\u{charRecursive:X4}.", "chars");
    }
}
