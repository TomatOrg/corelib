...
namespace System.Text
{
    ...
    public sealed partial class StringBuilder
    {
        ...
        public StringBuilder(string? value, int startIndex, int length, int capacity)
        {
            ...
            if (startIndex < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(startIndex), ArgumentOutOfRangeException.StartIndex);
            }
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(length), ArgumentOutOfRangeException.IndexLength);
            }
        ...
        public StringBuilder(int capacity, int maxCapacity)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(capacity), ArgumentOutOfRangeException.Capacity);
            }
            if (maxCapacity < 1)
            {
                throw new ArgumentOutOfRangeException(nameof(maxCapacity), ArgumentOutOfRangeException.SmallMaxCapacity);
            }
            if (capacity < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(capacity), $"'{nameof(capacity)}' must be greater than zero.");
        ...
        public int Capacity
        {
            ...
            set
            {
                if (value < 0)
                {
                    throw new ArgumentOutOfRangeException(nameof(value), ArgumentOutOfRangeException.NegativeCapacity);
                }
                if (value > MaxCapacity)
                {
                    throw new ArgumentOutOfRangeException(nameof(value), ArgumentOutOfRangeException.Capacity);
                }
                if (value < Length)
                {
                    throw new ArgumentOutOfRangeException(nameof(value), ArgumentOutOfRangeException.SmallCapacity);
                }
        ...
        public int EnsureCapacity(int capacity)
        {
            if (capacity < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(capacity), ArgumentOutOfRangeException.NegativeCapacity);
            }
        ...
        public override string ToString()
        {
            ...
            do
            {
                if (chunk.m_ChunkLength > 0)
                {
                    ...
                    {
                        throw new ArgumentOutOfRangeException(nameof(chunkLength), ArgumentOutOfRangeException.Index);
                    }
        ...
        public string ToString(int startIndex, int length)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(startIndex), ArgumentOutOfRangeException.StartIndexLargerThanLength);
            }
            if (length < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(length), ArgumentOutOfRangeException.NegativeLength);
            }
        ...
        public int Length
        {
            ...
            set
            {
                ...
                if (value < 0)
                {
                    throw new ArgumentOutOfRangeException(nameof(value), ArgumentOutOfRangeException.NegativeLength);
                }
            ...
            set
            {
                ...
                while (true)
                {
                    ...
                    if (indexInBlock >= 0)
                    {
                        if (indexInBlock >= chunk.m_ChunkLength)
                        {
                            throw new ArgumentOutOfRangeException(nameof(index), ArgumentOutOfRangeException.Index);
                        }
        ...
        public StringBuilder Append(char value, int repeatCount)
        {
            if (repeatCount < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(repeatCount), ArgumentOutOfRangeException.NegativeCount);
            }
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(repeatCount), ArgumentOutOfRangeException.LengthGreaterThanCapacity);
            }
        ...
        public StringBuilder Append(char[]? value, int startIndex, int charCount)
        {
            if (startIndex < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(startIndex), ArgumentOutOfRangeException.GenericPositive);
            }
            if (charCount < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(charCount), ArgumentOutOfRangeException.GenericPositive);
            }
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(charCount), ArgumentOutOfRangeException.Index);
            }
        ...
        public StringBuilder Append(string? value, int startIndex, int count)
        {
            ...
            if (count < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(count), ArgumentOutOfRangeException.GenericPositive);
            }
        ...
        public void CopyTo(int sourceIndex, char[] destination, int destinationIndex, int count)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(destinationIndex), $"'{nameof(destinationIndex)}' must be non-negative.");
            }

            if (destinationIndex > destination.Length - count)
            {
                throw new ArgumentException(ArgumentException.OffsetOut);
            }
        ...
        public void CopyTo(int sourceIndex, Span<char> destination, int count)
        {
            if (count < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(count), ArgumentOutOfRangeException.NegativeArgCount);
            }
            ...
            {
                throw new ArgumentException(ArgumentException.LongerThanSrcString);
            }
...
#pragma warning restore CA1830
        ...
        public StringBuilder Insert(int index, char[]? value, int startIndex, int charCount)
        {
            ...
            if (value == null)
            {
                ...
                throw new ArgumentNullException(nameof(value), ArgumentNullException.String);
            }
        ...
        {
            throw new FormatException(FormatException.InvalidString);
        }
        ...
        internal StringBuilder AppendFormatHelper(IFormatProvider? provider, string format, ParamsArray args)
        {
            ...
            while (true)
            {
                ...
                {
                    throw new FormatException(FormatException.IndexOutOfRange);
                }
        ...
        public StringBuilder Replace(string oldValue, string? newValue, int startIndex, int count)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(count), ArgumentOutOfRangeException.Index);
            }
            if (oldValue == null)
            {
            ...
            {
                throw new ArgumentException(ArgumentException.EmptyName, nameof(oldValue));
            }
        ...
        public unsafe StringBuilder Append(ref char value, int valueCount)
        {
            ...
            if (valueCount < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(valueCount), ArgumentOutOfRangeException.NegativeCount);
            }
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(valueCount), ArgumentOutOfRangeException.LengthGreaterThanCapacity);
            }
        ...
        private void ExpandByABlock(int minBlockCharCount)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("requiredLength", ArgumentOutOfRangeException.SmallCapacity);
            }
