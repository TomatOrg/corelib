...
namespace System
{
    ...
    public readonly partial struct Guid : ISpanFormattable, IComparable<Guid>, IEquatable<Guid>
    {
        ...
        private struct GuidResult
        {
            ...
            internal readonly void SetFailure(bool overflow, string failureMessage)
            {
        ...
        public static Guid ParseExact(ReadOnlySpan<char> input, ReadOnlySpan<char> format)
        {
            if (format.Length != 1)
            {
                ...
                throw new FormatException(FormatException.InvalidGuidFormatSpecification);
            }
            ...
            bool success = ((char)(format[0] | 0x20)) switch
            {
                ...
                _ => throw new FormatException(FormatException.InvalidGuidFormatSpecification),
            };
            Debug.Assert(success, "GuidParseThrowStyle.AllButOverflow means throw on all failures");
            return result.ToGuid();
        }
        ...
        private static bool TryParseGuid(ReadOnlySpan<char> guidString, ref GuidResult result)
        {
            ...
            {
                result.SetFailure(overflow: false, "Unrecognized Guid format.");
                return false;
            }
        ...
        private static bool TryParseExactB(ReadOnlySpan<char> guidString, ref GuidResult result)
        {
            ...
            {
                result.SetFailure(overflow: false, FormatException.GuidInvLen);
                return false;
            }
        ...
        private static bool TryParseExactD(ReadOnlySpan<char> guidString, ref GuidResult result)
        {
            ...
            {
                result.SetFailure(overflow: false, guidString.Length != 36 ? FormatException.GuidInvLen : "Dashes are in the wrong position for GUID parsing.");
                return false;
            }
            ...
            result.SetFailure(overflow: false, FormatException.GuidInvalidChar);
            return false;
        ...
        private static bool TryParseExactX(ReadOnlySpan<char> guidString, ref GuidResult result)
        {
            ...
            {
                result.SetFailure(overflow: false, FormatException.GuidBrace);
                return false;
            }
            ...
            {
                result.SetFailure(overflow: false, FormatException.GuidHexPrefix);
                return false;
            }
            ...
            if (numLen <= 0)
            {
                result.SetFailure(overflow: false, FormatException.GuidComma);
                return false;
            }
            ...
            {
                result.SetFailure(overflow, overflow ? OverflowException.UInt32 : FormatException.GuidInvalidChar);
                return false;
            }
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                else // last case ends with '}', not ','
                {
                    ...
                    if (numLen <= 0)
                    {
                        result.SetFailure(overflow: false, FormatException.GuidBraceAfterLastNumber);
                        return false;
                    }
                }
                ...
                if (!TryParseHex(guidString.Slice(numStart, numLen), out uint byteVal, ref overflow) || overflow || byteVal > byte.MaxValue)
                {
                    ...
                    result.SetFailure(overflow,
                        overflow ? OverflowException.UInt32 :
                        byteVal > byte.MaxValue ? OverflowException.Byte :
                        FormatException.GuidInvalidChar);
                    return false;
                }
            ...
            {
                result.SetFailure(overflow: false, FormatException.GuidEndBrace);
                return false;
            }
            ...
            {
                result.SetFailure(overflow: false, FormatException.ExtraJunkAtEnd);
                return false;
            }
