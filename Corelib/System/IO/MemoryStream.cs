...
namespace System.IO
{
    ...
    public class MemoryStream : Stream
    {
        ...
        public override long Position
        {
            ...
            {
                if (value < 0)
                    throw new ArgumentOutOfRangeException(nameof(value), ArgumentOutOfRangeException.NeedNonNegNum);

                EnsureNotClosed();

                if (value > MemStreamMaxLength)
                    throw new ArgumentOutOfRangeException(nameof(value), ArgumentOutOfRangeException.StreamLength);
        ...
        public override long Seek(long offset, SeekOrigin loc)
        {
            ...
            if (offset > MemStreamMaxLength)
                throw new ArgumentOutOfRangeException(nameof(offset), ArgumentOutOfRangeException.StreamLength);
                ...
                case SeekOrigin.Begin:
                    {
                        ...
                        if (offset < 0 || tempPosition < _origin)
                            throw new IOException(IOException.SeekBeforeBegin);
