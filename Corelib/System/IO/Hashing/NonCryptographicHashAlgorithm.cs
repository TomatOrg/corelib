...
namespace System.IO.Hashing
{
    ...
    public abstract class NonCryptographicHashAlgorithm
    {
        ...
        public int GetCurrentHash(Span<byte> destination)
        {
            if (destination.Length < HashLengthInBytes)
            {
                throw new ArgumentException(ArgumentException.DestinationTooShort, nameof(destination));
            }
...
#pragma warning restore CS0809 // Obsolete member overrides non-obsolete member
        {
            throw new NotSupportedException("The GetHashCode method is not supported on this object. Use GetCurrentHash or GetHashAndReset to retrieve the hash code computed by this object.");
        }
    }
}
