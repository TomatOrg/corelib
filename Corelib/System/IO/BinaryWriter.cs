...
namespace System.IO
{
    ...
    public class BinaryWriter : IDisposable, IAsyncDisposable
    {
        ...
        public BinaryWriter(Stream output, Encoding encoding, bool leaveOpen)
        {
            ...
            if (!output.CanWrite)
                throw new ArgumentException(ArgumentException.StreamNotWritable);
        ...
        public virtual void Write(char[] chars, int index, int count)
        {
            ...
            if (index > chars.Length - count)
                throw new ArgumentOutOfRangeException(nameof(index), ArgumentOutOfRangeException.IndexCount);
