...
namespace System.IO
{
    ...
    public class StreamReader : TextReader
    {
        ...
        private static void ThrowAsyncIOInProgress() =>
            throw new InvalidOperationException(InvalidOperationException.AsyncIOInProgress);
        ...
        public StreamReader(Stream stream, Encoding? encoding = null, bool detectEncodingFromByteOrderMarks = true, int bufferSize = -1, bool leaveOpen = false)
        {
            ...
            if (!stream.CanRead)
            {
                throw new ArgumentException(ArgumentException.StreamNotReadable);
            }
            if (bufferSize == -1)
            {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(bufferSize), ArgumentOutOfRangeException.NeedPosNum);
            }
        ...
        private void CompressBuffer(int n)
        {
            ...
            Array.Copy(_byteBuffer, n, _byteBuffer, 0, _byteLen - n);
            _byteLen -= n;
        }
        ...
        private void ThrowIfDisposed()
        {
            ...
            void ThrowObjectDisposedException() => throw new ObjectDisposedException(GetType().Name, ObjectDisposedException.ReaderClosed);
        }
