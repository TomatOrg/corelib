...
namespace System
{
    public partial class String
    {
        ...
        private static string JoinCore(ReadOnlySpan<char> separator, string?[] value, int startIndex, int count)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(startIndex), ArgumentOutOfRangeException.IndexCountBuffer);
            }
        ...
        {
            if (totalWidth < 0)
                throw new ArgumentOutOfRangeException(nameof(totalWidth), ArgumentOutOfRangeException.NeedNonNegNum);
            int oldLength = Length;
        ...
        public string Remove(int startIndex, int count)
        {
            ...
            if (count > oldLength - startIndex)
                throw new ArgumentOutOfRangeException(nameof(count), ArgumentOutOfRangeException.IndexCount);
        ...
        {
            if ((uint)startIndex > Length)
                throw new ArgumentOutOfRangeException(nameof(startIndex), startIndex < 0 ? ArgumentOutOfRangeException.StartIndex : ArgumentOutOfRangeException.StartIndexLargerThanLength);
        ...
        public string Replace(string oldValue, string? newValue, StringComparison comparisonType)
        {
            switch (comparisonType)
            {
                ...
                default:
                    throw new ArgumentException(ArgumentException.StringComparison, nameof(comparisonType));
            }
        }
        ...
        //     {
        //         throw new ArgumentException(ArgumentException.StringZeroLength, nameof(oldValue));
        //     }
        //
        ...
        //
        //     var result = new ValueStringBuilder(/*stackalloc char[256]*/ 256);
        ...
        private void MakeSeparatorList(ReadOnlySpan<char> separators, ref ValueListBuilder<int> sepListBuilder)
        {
            ...
            else
            {
                ...
                InitializeProbabilisticMap(ref charMap, separators);

                for (int i = 0; i < Length; i++)
                {
                    char c = this[i];
                    if (IsCharBitSet(ref charMap, (byte)c) && IsCharBitSet(ref charMap, (byte)(c >> 8)) &&
        ...
        public unsafe string Trim(char trimChar) => TrimHelper(ref trimChar, 1, TrimType.Both);
        ...
        public unsafe string Trim(params char[]? trimChars)
        {
            ...
            return TrimHelper(ref trimChars[0], trimChars.Length, TrimType.Both);
        }
        ...
        // Removes a set of characters from the beginning of this string.
        public unsafe string TrimStart(char trimChar) => TrimHelper(ref trimChar, 1, TrimType.Head);
        ...
        public unsafe string TrimStart(params char[]? trimChars)
        {
            ...
            return TrimHelper(ref trimChars[0], trimChars.Length, TrimType.Head);
        }
        ...
        // Removes a set of characters from the end of this string.
        public unsafe string TrimEnd(char trimChar) => TrimHelper(ref trimChar, 1, TrimType.Tail);
        ...
        public unsafe string TrimEnd(params char[]? trimChars)
        {
            ...
            return TrimHelper(ref trimChars[0], trimChars.Length, TrimType.Tail);
        }
        ...
        private unsafe string TrimHelper(ref char trimChars, int trimCharsLength, TrimType trimType)
        {
            ...
            if ((trimType & TrimType.Head) != 0)
            {
                for (start = 0; start < Length; start++)
                {
                    ...
                    {
                        if (Unsafe.Add(ref trimChars, i) == ch)
                        {
                            break;
                        }
                    }
