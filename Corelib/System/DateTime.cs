...
namespace System
{
    ...
    public readonly partial struct DateTime : /*ISpanFormattable, */IComparable<DateTime>, IEquatable<DateTime>
    {
        ...
        private static void ThrowTicksOutOfRange() => throw new ArgumentOutOfRangeException("ticks", "Ticks must be between DateTime.MinValue.Ticks and DateTime.MaxValue.Ticks.");
        private static void ThrowInvalidKind() => throw new ArgumentException("Invalid DateTimeKind value.", "kind");
        ...
        private static void ThrowDateArithmetic(int param) => throw new ArgumentOutOfRangeException(param switch { 0 => "value", 1 => "t", _ => "months" }, "The added or subtracted value results in an un-representable DateTime.");
        ...
        private DateTime Add(double value, int scale)
        {
            ...
            static void ThrowOutOfRange() => throw new ArgumentOutOfRangeException(nameof(value), ArgumentOutOfRangeException.AddValue);
        }
        ...
        {
            if (months < -120000 || months > 120000) throw new ArgumentOutOfRangeException(nameof(months), "Months value must be between +/-120000.");
        ...
        public DateTime AddYears(int value)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(value), "Years value must be between +/-10000.");
            }
            GetDate(out int year, out int month, out int day);
            int y = year + value;
        ...
        public static DateTime FromBinary(long dateData)
        {
            ...
            else
            {
                if (((ulong)dateData & TicksMask) > MaxTicks)
                    throw new ArgumentException(ArgumentException.DateTimeBadBinaryData, nameof(dateData));
