...
{
    public class HashSet<T> : ICollection<T>, ISet<T>, IReadOnlyCollection<T>, IReadOnlySet<T>
    {
        ...
        public void CopyTo(T[] array, int arrayIndex, int count)
        {
            ...
            if (arrayIndex < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(arrayIndex), arrayIndex, ArgumentOutOfRangeException.NeedNonNegNum);
            }

            // Also throw if count less than 0.
            if (count < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(count), count, ArgumentOutOfRangeException.NeedNonNegNum);
            }
