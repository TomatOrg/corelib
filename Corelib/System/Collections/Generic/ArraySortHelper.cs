...
namespace System.Collections.Generic
{
    ...
    internal sealed partial class ArraySortHelper<T> : IArraySortHelper<T>
    {
        ...
        private static IArraySortHelper<T> CreateArraySortHelper()
        {
            ...
            {
                defaultArraySortHelper = (IArraySortHelper<T>)RuntimeTypeHandle.CreateInstanceForAnotherGenericParameter(typeof(GenericArraySortHelper<string>), typeof(T));
            }
            else
            {
    ...
    internal sealed partial class ArraySortHelper<TKey, TValue> : IArraySortHelper<TKey, TValue>
    {
        ...
        private static IArraySortHelper<TKey, TValue> CreateArraySortHelper()
        {
            ...
            {
                defaultArraySortHelper = (IArraySortHelper<TKey, TValue>)RuntimeTypeHandle.CreateInstanceForAnotherGenericParameter(typeof(GenericArraySortHelper<string, string>), typeof(TKey), typeof(TValue));
            }
            else
            {
