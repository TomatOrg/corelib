...
namespace System.Collections.Generic
{
        ...
        IReadOnlyCollection<T>
    {
        ...
        {
            if (capacity < 0)
                throw new ArgumentOutOfRangeException(nameof(capacity), capacity, ArgumentOutOfRangeException.NeedNonNegNum);
        ...
        public void CopyTo(T[] array, int arrayIndex)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(arrayIndex), arrayIndex, ArgumentOutOfRangeException.Index);
            }
            ...
            System.Collections.IEnumerator
        {
            ...
            {
                if (_version != _q._version) throw new InvalidOperationException(InvalidOperationException.EnumFailedVersion);
            ...
            private void ThrowEnumerationNotStartedOrEnded()
            {
                ...
                throw new InvalidOperationException(_index == -1 ? InvalidOperationException.EnumNotStarted : InvalidOperationException.EnumEnded);
            }
