...
{
    public readonly struct BigInteger : ISpanFormattable, IComparable<BigInteger>, IEquatable<BigInteger>
    {
        ...
        {
            if (exponent.Sign < 0)
                throw new ArgumentOutOfRangeException(nameof(exponent), ArgumentOutOfRangeException.MustBeNonNeg);
        ...
        public static explicit operator int(BigInteger value)
        {
            ...
            {
                // More than 32 bits
                throw new OverflowException(OverflowException.Int32);
            }
            if (value._sign > 0)
            {
        ...
        public static explicit operator uint(BigInteger value)
        {
            ...
            {
                throw new OverflowException(OverflowException.UInt32);
            }
            else
            {
        ...
        public static explicit operator long(BigInteger value)
        {
            ...
            if (len > 2)
            {
                throw new OverflowException(OverflowException.Int64);
            }
        ...
        public static explicit operator ulong(BigInteger value)
        {
            ...
            {
                throw new OverflowException(OverflowException.UInt64);
            }
