...
#pragma warning restore CA1825
        ...
        public long GlobalCount => timeSensitiveWorkQueue!.Count + workItems.Count;
    ...
    public static partial class ThreadPool
    {
             ...
             )
        {
            if (millisecondsTimeOutInterval > (uint)int.MaxValue && millisecondsTimeOutInterval != uint.MaxValue)
                throw new ArgumentOutOfRangeException(nameof(millisecondsTimeOutInterval), ArgumentOutOfRangeException.LessEqualToIntegerMaxVal);
        ...
        {
            if (millisecondsTimeOutInterval > (uint)int.MaxValue && millisecondsTimeOutInterval != uint.MaxValue)
                throw new ArgumentOutOfRangeException(nameof(millisecondsTimeOutInterval), ArgumentOutOfRangeException.NeedNonNegOrNegative1);
