...
namespace System.Threading
{
    ...
    public readonly struct CancellationToken
    {
        ...
        public CancellationTokenRegistration Register(Action<object?> callback, object? state) =>
            Register(callback, state, useExecutionContext: true);
        ...
        public CancellationTokenRegistration UnsafeRegister(Action<object?> callback, object? state) =>
            Register(callback, state, useExecutionContext: false);
        ...
        /// <exception cref="System.ObjectDisposedException">The associated <see
        /// cref="System.Threading.CancellationTokenSource">CancellationTokenSource</see> has been disposed.</exception>
        private CancellationTokenRegistration Register(Delegate callback, object? state, bool useExecutionContext)
        {
            if (callback == null)
            ...
            return source != null ?
                source.Register(callback, state, useExecutionContext ? ExecutionContext.Capture() : null) :
