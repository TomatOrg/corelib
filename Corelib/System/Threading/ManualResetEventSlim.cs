        ...
        private int Waiters
        {
            ...
            set
            {
                ...
                if (value >= NumWaitersState_MaxValue)
                    throw new InvalidOperationException( $"There are too many threads currently waiting on the event. A maximum of {NumWaitersState_MaxValue} waiting threads are supported.");
        ...
        public ManualResetEventSlim(bool initialState, int spinCount)
        {
            ...
            if (spinCount > SpinCountState_MaxValue)
            {
                throw new ArgumentOutOfRangeException(
                    nameof(spinCount),
                    $"The spinCount argument must be in the range 0 to {SpinCountState_MaxValue}, inclusive.");
            }
