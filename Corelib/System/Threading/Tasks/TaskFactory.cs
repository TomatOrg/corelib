...
namespace System.Threading.Tasks
{
    ...
    public class TaskFactory
    {
        ...
        internal static void CheckFromAsyncOptions(TaskCreationOptions creationOptions, bool hasBeginMethod)
        {
            if (hasBeginMethod)
            {
                ...
                if ((creationOptions & TaskCreationOptions.LongRunning) != 0)
                    throw new ArgumentOutOfRangeException(nameof(creationOptions), "It is invalid to specify TaskCreationOptions.LongRunning in calls to FromAsync.");
                if ((creationOptions & TaskCreationOptions.PreferFairness) != 0)
                    throw new ArgumentOutOfRangeException(nameof(creationOptions), "It is invalid to specify TaskCreationOptions.PreferFairness in calls to FromAsync.");
            }
        ...
        internal static Task<Task> CommonCWAnyLogic(IList<Task> tasks, bool isSyncBlocking = false)
        {
            ...
            {
                Task task = tasks[i];
                if (task == null) throw new ArgumentException(ArgumentException.NullTask, nameof(tasks));
        ...
        internal static Task[] CheckMultiContinuationTasksAndCopy(Task[] tasks)
        {
            ...
            if (tasks.Length == 0)
                throw new ArgumentException(ArgumentException.EmptyTaskList, nameof(tasks));
            ...
            for (int i = 0; i < tasks.Length; i++)
            {
                ...
                if (tasksCopy[i] == null)
                    throw new ArgumentException(ArgumentException.NullTask, nameof(tasks));
            }
        ...
        internal static void CheckMultiTaskContinuationOptions(TaskContinuationOptions continuationOptions)
        {
            ...
            if ((continuationOptions & NotOnAny) != 0)
                throw new ArgumentOutOfRangeException(nameof(continuationOptions), "It is invalid to exclude specific continuation kinds for continuations off of multiple tasks.");
        }
    }
}
