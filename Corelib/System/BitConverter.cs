    ...
    public static class BitConverter
    {
        ...
        public static string ToString(byte[] value, int startIndex, int length)
        {
            ...
            if (startIndex < 0 || startIndex >= value.Length && startIndex > 0)
                ThrowHelper.ThrowArgumentOutOfRangeException(ExceptionArgument.startIndex, ExceptionResource.ArgumentOutOfRange_Index);
            if (length < 0)
                throw new ArgumentOutOfRangeException(nameof(length), ArgumentOutOfRangeException.GenericPositive);
            ...
            if (length > (int.MaxValue / 3))
            {
                ...
                throw new ArgumentOutOfRangeException(nameof(length), $"The specified length exceeds the maximum value of {int.MaxValue / 3}.");
            }
