...
namespace System
{
    ...
    //
    public readonly struct TimeSpan : IComparable<TimeSpan>, IEquatable<TimeSpan>/*, ISpanFormattable*/
    {
        ...
        public TimeSpan(int days, int hours, int minutes, int seconds, int milliseconds)
        {
            ...
            if (totalMilliSeconds > MaxMilliSeconds || totalMilliSeconds < MinMilliSeconds)
                throw new ArgumentOutOfRangeException(null, OverflowException.TimeSpanTooLong);
        ...
        public TimeSpan Add(TimeSpan ts)
        {
            ...
            if ((_ticks >> 63 == ts._ticks >> 63) && (_ticks >> 63 != result >> 63))
                throw new OverflowException(OverflowException.TimeSpanTooLong);
        ...
        public TimeSpan Duration()
        {
            if (Ticks == TimeSpan.MinValue.Ticks)
                throw new OverflowException(OverflowException.Duration);
        ...
        private static TimeSpan Interval(double value, double scale)
        {
            if (double.IsNaN(value))
                throw new ArgumentException(ArgumentException.CannotBeNaN);
        ...
        //     {
        //         throw new ArgumentException(ArgumentException.CannotBeNaN, nameof(factor));
        //     }
        //
        ...
        //     {
        //         throw new ArgumentException(ArgumentException.CannotBeNaN, nameof(divisor));
        //     }
        //
