    ...
    internal static partial class Number
    {
        ...
        private static Exception GetException(ParsingStatus status, TypeCode type)
        {
            if (status == ParsingStatus.Failed)
                return new FormatException(FormatException.InvalidString);

            string s;
            switch (type)
            {
                case TypeCode.SByte:
                    s = "Value was either too large or too small for a signed byte.";
                    break;
                case TypeCode.Byte:
                    s = "Value was either too large or too small for an unsigned byte.";
                    break;
                case TypeCode.Int16:
                    s = "Value was either too large or too small for an Int16.";
                    break;
                case TypeCode.UInt16:
                    s = "Value was either too large or too small for a UInt16.";
                    break;
                case TypeCode.Int32:
                    s = "Value was either too large or too small for an Int32.";
                    break;
                case TypeCode.UInt32:
                    s = "Value was either too large or too small for a UInt32.";
                    break;
                case TypeCode.Int64:
                    s = "Value was either too large or too small for an Int64.";
                    break;
                case TypeCode.UInt64:
                    s = "Value was either too large or too small for a UInt64.";
                    break;
                default:
                    Debug.Assert(type == TypeCode.Decimal);
                    s = "Value was either too large or too small for a Decimal.";
                    break;
            }
